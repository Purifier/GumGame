...
public class L_1_3 extends Location {

    public L_1_3(GameSurface gameSurface) {
        super(gameSurface);
    ...
    @Override
    public void init() {
        gameSurface.createPlatform(bitmapPlatform,-100,getHeight()*3/4,getWidth()/2,getHeight());
